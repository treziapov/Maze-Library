...
public class DijkstrasAlgorithmTest {
	...
	private static DijkstrasAlgorithm solver;
	private static Heuristic heuristic = new ManhattanDistance();
	...
	public void testInitialization() 
	{
		...
		{
			fail("Initializaion failed!");
		}
		
		try
		{
			solver = new DijkstrasAlgorithm(MAZE_STRING, heuristic);
		}
		catch (Exception e)
		{
			fail("String initializaion failed!");
		}
	}
	...
	public void testOpenArea()
	{
		...
		solver = new DijkstrasAlgorithm(wallMaze, heuristic);
	 ...
	 * Shortest path is the one with most diagonal moves.
	 */
	@Test
	public void testChooseShortestPath()
	{
		...
		solver = new DijkstrasAlgorithm(multiplePaths, heuristic);
	...
	public void testBigMaze()
	{
		...
		solver = new DijkstrasAlgorithm(big, heuristic);
	 ...
	 * called twice and returns a String representation of 
